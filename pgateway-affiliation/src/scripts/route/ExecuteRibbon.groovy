...
public class ExecuteRibbon extends GateFilter {
	...
	public HttpResponse forward(AbstractLoadBalancerAwareClient client,IClientConfig clientConfig, String verb, String uri, String serviceName,
		...
		if (StringUtils.isBlank(RequestContext.getCurrentContext().getRequest().getHeader(Constants.CAT_ROOT_MESSAGE_ID))) {

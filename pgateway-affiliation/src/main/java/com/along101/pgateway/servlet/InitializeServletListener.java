...
public class InitializeServletListener implements ServletContextListener {
    ...
    public InitializeServletListener() {
        ...
        if (applicationID == null || applicationID.isEmpty()) {
            ...
            System.setProperty(Constants.DeployConfigUrl, "http://localhost:8083/configs/apollo/10010003");        //old: localhost:8080
            System.setProperty(Constants.DeploymentApplicationID, "affgate");
        }
        loadConfiguration();
        configLog();
        registerEureka();

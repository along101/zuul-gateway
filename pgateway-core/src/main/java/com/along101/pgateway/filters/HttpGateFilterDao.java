...
public class HttpGateFilterDao implements IGateFilterDao {
	private static final Logger LOGGER = LoggerFactory.getLogger(HttpGateFilterDao.class);
	
    private DynamicStringProperty filterRepository = DynamicPropertyFactory.getInstance().getStringProperty(Constants.GateFilterRepo, "http://localhost:8080/filters");
    private String applicationName;
    private CloseableHttpClient httpclient;
	public HttpGateFilterDao(String applicationName){

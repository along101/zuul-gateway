...
import com.along101.pgateway.core.FilterFileManager;
import com.along101.pgateway.core.FilterLoader;
import com.along101.pgateway.core.LogConfigurator;
import com.along101.pgateway.filters.GateFilterPoller;
import com.along101.pgateway.groovy.GroovyCompiler;
import com.along101.pgateway.groovy.GroovyFileFilter;
...
//		System.setProperty(Constants.DeploymentApplicationID, "wirelessgate");
//		System.setProperty(Constants.DeployConfigUrl, "http://localhost:8080/configs/apollo/10010001");
        ...
        if (applicationID == null || applicationID.isEmpty()) {
            ...
            //System.setProperty(Constants.DeployConfigUrl, "http://uat-apconfig.along101corp.com/configs/apollo/10010001");
            ConfigurationManager.getConfigInstance().setProperty(Constants.DeployConfigUrl, "http://localhost:8083/configs/apollo/10010001");    //old：localhost:8080
